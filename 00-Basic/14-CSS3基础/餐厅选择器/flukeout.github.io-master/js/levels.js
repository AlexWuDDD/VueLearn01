var levels = [
  ...
  },
  {
    ...
    help : '',
    examples : [
      '<strong>img[src$=".jpg"]</strong> selects all images display a <strong>.jpg</strong> img.',
    ],
    boardMarkup:`
    <apple class="small"/>
  ...
  },
  {
    ...
    examples : [
      '<strong>img[src*="/thumbnails/"]</strong> selects all img elements that show images from the "thumbnails" folder.',
